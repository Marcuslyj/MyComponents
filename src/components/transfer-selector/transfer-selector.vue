<template>
  <div class="wrapper">
    <div class="ivu-transfer">
      <!-- 左侧 -->
      <div class="ivu-transfer-list" ref="left-wrapper" v-show="!readonly">
      ...
      <!-- 中间 -->
      <div class="ivu-transfer-operation" v-show="!readonly">
      ...
      <div class="ivu-transfer-list" ref="right-wrapper">
        <div class="ivu-transfer-list-header">
          <span class="ivu-transfer-list-header-title" v-show="!readonly">
            <Checkbox v-show="!searchRightFlag" v-model="checkAll_right" @on-change="toggleAll($event,'dataRight','checkedRight',$refs.rightList,'checkAll_right')" :disabled="dataRight.length ==0">已选</Checkbox>
            <Checkbox v-show="searchRightFlag" v-model="checkAll_right_match" @on-change="toggleAll($event,'dataRight_match','checkedRight_match',$refs.rightList_match,'checkAll_left_match')" :disabled="dataRight_match.length ==0">已选</Checkbox>
          </span>
...
export default {
  ...
  methods: {
    ...
    //对外，返回已选
    getSelected() {
      let nodeInfos = this.getTreeNodes(this.dataRight);
